...
import {TextField, Toggle, Announced, DetailsList, DetailsListLayoutMode, Selection, SelectionMode, MarqueeSelection, mergeStyleSets, TooltipHost, Text, Link, ThemeProvider, initializeIcons  } from "@fluentui/react";
...
class DetailsListDocumentsExample extends React.Component<{}, IDetailsListDocumentsExampleState> {
  ...
  public componentDidUpdate(_previousProps: any, previousState: IDetailsListDocumentsExampleState) {
  ...
  private _onChangeModalSelection = (_ev: React.MouseEvent<HTMLElement>, checked: boolean): void => {
    this.setState({ isModalSelection: checked });
  };

  private _onChangeText = (_ev: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, text: string): void => {
    this.setState({
...
const DetailsListDocumentsExampleWrapper = () => <ThemeProvider><DetailsListDocumentsExample /></ThemeProvider>;
ReactDOM.render(<DetailsListDocumentsExampleWrapper />, document.getElementById('content'))